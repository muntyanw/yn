                    ...
                    <div class="col-md-6">
                        ...
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                ...
                                <a href="mailto:pounitednation@gmail.com"
                                    class="nav-link text-light d-inline-block">pounitednation@gmail.com</a>
                            </li>
                            <li class="nav-item">
                                <i class="fas fa-phone text-light"></i>
                                <a href="tel:+380731654000" class="nav-link text-light d-inline-block">(+38)
                                    073-1654-000</a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <ul class="nav justify-content-center">
                            <li class="nav-item"><a href="https://www.facebook.com/profile.php?id=100059036389164"
